...
客戶提問「我的醫療保障夠嗎？」→ 機器人只能回傳保障金額清單，無法結合年齡、已有保單、家庭結構給予<strong>個人化建議</strong>，客戶仍需自行判斷。
</div>

<div class="pain-box">
<span class="icon">⚠️ Gap 2：被動等待，錯失關鍵服務時機</span><br>
現有系統為客戶主動發問才啟動，未能在<strong>保單到期前、理賠後、生命事件發生時</strong>主動出擊，提供有溫度的個人化關懷。
</div>
...
<div class="card" style="border-left-color: var(--navy); font-size: 16px;">👶 <strong>家庭結構異動</strong>：子女 / 婚姻事件偵測</div>
...
<div style="background: var(--light); padding: 12px; border-radius: 8px; font-size: 15px;">
🧑‍💼 <strong>業務員</strong><br>AI 輔助，效率 ×3
</div>
<div style="background: var(--light); padding: 12px; border-radius: 8px; font-size: 15px;">
...
| 階段 | 時程 | 重點工作 | 預期產出 |
|------|------|----------|----------|
| **Phase 1**<br>基礎建設 | 月 1–3 | · 保單條款向量化<br>· RAG 基礎架構建置<br>· 中文情緒分類模型訓練 | RAG Prototype<br>情緒分類器 v1 |
| **Phase 2**<br>核心功能 | 月 4–6 | · 多輪對話引擎整合<br>· 生命事件觸發系統<br>· 合規護欄建置 | 內測版上線<br>業務員工具整合 |
| **Phase 3**<br>迭代優化 | 月 7–9 | · 用戶反饋收集 & RLHF<br>· 情緒路由上線<br>· 管理儀表板 | 正式對外上線<br>A/B 測試 |
| **Phase 4**<br>規模化 | 月 10–12 | · 多管道整合（APP / LINE / Call）<br>· 模型定期再訓練機制 | 全渠道覆蓋<br>效益報告 |
